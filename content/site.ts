    ...
    },
    {
      ...
      items: [
        workLink("ebay", {
          size: "2x1",
          icon: "ebay",
          blurb: "Staff engineer — global marketplace",
        }),
        workLink("kleinanzeigen", {
          size: "1x2",
          icon: "kleinanzeigen",
          blurb: "Senior Android — DE classifieds",
        ...
        workLink("leboncoin", {
          size: "half",
          icon: "leboncoin",
          blurb: "Classifieds — Adevinta family",
        ...
        workLink("yaoota", {
          size: "half",
          icon: "yaoota",
          blurb: "Installments + search ~250K users",
          downloadsKey: "yaoota",
        }),
        workLink("zad", {
          size: "half",
          icon: "zad",
          blurb: "~250K MAU Emotion Assistant · 4.7★",
          downloadsKey: "zad",
        }),
        workLink("hitchhiker", {
          size: "half",
          icon: "hitchhiker",
          blurb: "Stabilized travel/shipping Android app",
        }),
      ],
    },
    {
